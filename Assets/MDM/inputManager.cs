...
public class inputManager : MonoBehaviour
{
    ...
    public static SteamVR_Controller.Device selectorHand1;

    private SteamVR_TrackedObject trackedObject2;
    public static SteamVR_Controller.Device selectorHand2;
    ...
    private void Awake()
    {
        ...
        trackedObject1 = hand1.GetComponent<SteamVR_TrackedObject>();
        trackedObject2 = hand2.GetComponent<SteamVR_TrackedObject>();

        selectorHand1 = SteamVR_Controller.Input((int)trackedObject1.index);
        selectorHand2 = SteamVR_Controller.Input((int)trackedObject2.index);
